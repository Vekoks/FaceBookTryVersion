[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(MeetLifeClient.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(MeetLifeClient.App_Start.NinjectWebCommon), "Stop")]
...
namespace MeetLifeClient.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IMeetLifeDbContext>().To<MeetLifeDbContext>().InRequestScope();
